...
VALUES
  (
    3,
    '2024-09-09 00:04:03.182192',
    '开始数据库备份过程 - 2024-09-08T16:04:00.016Z\n数据库配置: {\"host\":\"119.23.48.155\",\"user\":\"pirate_admin_dev\",\"password\":\"***\",\"database\":\"pirate_admin_dev\"}\n开始执行 mysqldump\n数据库备份成功完成\n备份文件: backup-2024-09-08T16-04-00-016Z.sql\n文件大小: 855.62 KB\n备份用时: 2.237 秒\n备份结束时间: 2024-09-08T16:04:02.253Z',
    1,
    NULL,
    'D:\\小冷睡着了\\Pirate-Admin\\packages\\server\\backups\\backup-2024-09-08T16-04-00-016Z.sql'
  );
